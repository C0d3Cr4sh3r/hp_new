...
2. Füge den SQL-Code aus `supabase/migrations/20251110000001_create_screenshots_table.sql` ein
...
2. **Admin Panel**: http://localhost:3000/admin → Screenshots Tab
3. **Public Gallery**: http://localhost:3000 → Screenshots Sektion
