...
### 1. Datenbank Setup:
Das SQL aus `supabase/migrations/20251110000002_create_portfolios_table.sql` in der Supabase Console ausführen.

### 2. Admin Panel öffnen:
1. **Development Server**: http://localhost:3000
2. **Admin Panel**: http://localhost:3000/admin → **Portfolio Tab**
